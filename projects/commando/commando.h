#include <stdio.h>             // provides core input and output capabilities
#include <stdlib.h>            // variety of operations, malloc included
...
#include <sys/stat.h>          // functions related to UNIX files and their access
#include <fcntl.h>             // POSIX functions for creating, opening and manipulating files
